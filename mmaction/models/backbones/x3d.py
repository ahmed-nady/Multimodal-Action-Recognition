...
#     def __init__(self, channels=256, inter_channels=16, TemporalAttentionType='global'):
#         super().__init__()
...
#         self.fc1 = nn.Linear(in_features=self.inter_channels, out_features=self.inter_channels, bias=False)
#         self.fc2 = nn.Linear(in_features=self.inter_channels, out_features=self.inter_channels, bias=False)
#         self.sigmoid = nn.Sigmoid()
#
#     def forward(self, x):
#         module_input = x
...
#         return module_input * (spatial_attention * temporal_attention)
#
#
# class BlockX3D(nn.Module):
#     """BlockX3D 3d building block for X3D.
...
#
#         if self.sta:
#             self.sta_module = SpatialTemporalAttention(outplanes)
#
#         self.relu = build_activation_layer(self.act_cfg)
#
#     def forward(self, x):
